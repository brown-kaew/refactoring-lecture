...
import (
	...
	"github.com/brown-kaew/refactoring-lecture/db-store/pkg/version"
)

// NewMainHandler creates all http handlers
func NewMainHandler(service SetGetDeleter) http.Handler {
	r := http.NewServeMux()
...
func NewHandler(service SetGetDeleter) *Handler {
